...
router.post('/users/:usersId/edit', foodie.edit) // POST will show the create page for new user profile
router.patch('/users/:usersId', foodie.update) // PATCH - updates user info 
...
router.post('/explorations', explore.edit) // POST will show the create page for new user profile
...
router.get('/explorations/:id/evaluation', eval.index) // GET navigates to user's reviews &&|| shows Reviews
